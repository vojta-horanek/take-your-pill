...
\boxik{
\textbf{ViewHolder} (doslovný překlad \enquote{držitel pohledu}) je třída, která se stará o zobrazení jedné položky v RecyclerView adaptéru. Má za úkol nastavit rozložení tak, aby odpovídalo vstupním datům (např. jednomu léku). Třídu si musíme definovat sami pro každý typ položky, které chceme zobrazovat.
}
